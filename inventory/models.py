...
class inventoryreq(models.Model):
    ...
    bought_price=models.DecimalField(max_digits=100000, decimal_places=2, blank=False)
    retail_price=models.DecimalField(max_digits=100000, decimal_places=2, blank=False)
